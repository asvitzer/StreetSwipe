...
interface PaymentApi {
    ...
    suspend fun getConnectionToken(): Response<ConnectionToken>
    ...
    suspend fun capturePaymentIntent(@Field("payment_intent_id") id: String): Response<Void>
    ...
    suspend fun cancelPaymentIntent(@Field("payment_intent_id") id: String): Response<Void>
}
